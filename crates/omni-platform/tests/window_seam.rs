...
/// `omni-platform`, and this is a test *of* the per-target split. Windows (Win32), macOS (AppKit)
/// and Linux (X11) have backends; `window_linux.rs` carries Linux's side of the same boundary.
