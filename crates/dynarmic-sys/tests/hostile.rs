...
enum Shape {
    ...
    /// stack buffer every time, which is the handler Omnidroid patch 0018
    ...
    /// the shape that isolates patch 0018's *budget* check, which `Return`
